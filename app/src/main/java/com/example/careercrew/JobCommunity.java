...
public class JobCommunity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_community);
        ...
        back.setOnClickListener(v -> {
            Intent intent = new Intent(JobCommunity.this, CommunitiesActivity.class);
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        if (communityName != null) {
                            ...
                            String welcomeMessage = "Hello, welcome to the Jobs Community, where we provide a diverse range of job opportunities that are independent of your current community. We invite you to explore the various listings available.";
